...
- 实现：
  ![一个跳跃表](https://github.com/jelinet/jelinet.github.io/blob/main/_posts/image/redis/skipList1.jpg)  
...
- 结构
  ![ziplist结构](https://github.com/jelinet/jelinet.github.io/blob/main/_posts/image/redis/ziplist1.jpg)  
...
- 结构
  ...
  ![编码常量](https://github.com/jelinet/jelinet.github.io/blob/main/_posts/image/redis/object1.jpg)
...
- 对象会在不同场景使用不同的编码；  
  ...
  3. 哈希对象编码：ziplist,hashtable;
     ![hash的ziplist编码](https://github.com/jelinet/jelinet.github.io/blob/main/_posts/image/redis/objecthash1.jpg)
  ...
  5. 有序集合编码：ziplist,skiplist;ziplist中按照score值顺序保存，先成员，后score；
     ![hash的ziplist编码](https://github.com/jelinet/jelinet.github.io/blob/main/_posts/image/redis/zsetziplist1.jpg)
