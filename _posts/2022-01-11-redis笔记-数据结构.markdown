...
- 实现：
  ![一个跳跃表](/Users/lixuemei08/Downloads/redis笔记/skipList1.jpg)  
...
- 结构
  ![ziplist结构](/Users/lixuemei08/Downloads/redis笔记/ziplist1.jpg)  
...
- 结构
  ...
  ![编码常量](/Users/lixuemei08/Downloads/redis笔记/object1.jpg)
...
- 对象会在不同场景使用不同的编码；  
  ...
  3. 哈希对象编码：ziplist,hashtable;
     ![hash的ziplist编码](/Users/lixuemei08/Downloads/redis笔记/objecthash1.jpg)
  ...
  5. 有序集合编码：ziplist,skiplist;ziplist中按照score值顺序保存，先成员，后score；
     ![hash的ziplist编码](/Users/lixuemei08/Downloads/redis笔记/zsetziplist1.jpg)
       ziplist条件：
