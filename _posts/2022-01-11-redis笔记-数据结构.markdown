...
- 实现：
  ![一个跳跃表](http://redisbook.com/_images/graphviz-8fc5de396a5b52c3d0b1991a1e09558ad055dd86.png)  
...
- 对象会在不同场景使用不同的编码；  
  ...
  3. 哈希对象编码：ziplist,hashtable;
     ![hash的ziplist编码](http://redisbook.com/_images/graphviz-7ba8b1f3af17e2e62cdf43608914333bf14d8e91.png)
  ...
  5. 有序集合编码：ziplist,skiplist;ziplist中按照score值顺序保存，先成员，后score；
     ![hash的ziplist编码](http://redisbook.com/_images/graphviz-8d7b7d0e78ad9d445ff14834e9e9618234395d46.png)
